   ...
   <body>
      <div class="container">
         ...
         <form action="" method="post" id="edit-form">
            ...
            <button type="button" class="btn btn-default" onclick="edit_user('<?php echo $data['user_id'];?>')">Submit</button>
         </form>
      </div>
   </body>
   <script>
      ...
      var formdata= $('#edit-form').serialize();
         ...
         $.ajax({
           ...
           $('#msg').html('<div class="alert alert-success"><strong>Success!</strong> User update successfully .</div>');
